...
\cvline{\textbf{Standards}}{ANSI C, J1979, J1939.}
...
\cvline{Dthoughts Systems}{\textbf{ECU Simulator Linux} - ECUSimLite Linux is a free PC application which uses CANMate device and CANMate API to implement ISO15765 compliant OBD2 ECU simulation.This can be used to test devices like OBD port readers without the need to connect to a vehicle.}
\cvline{Dthoughts Systems}{\textbf{J1939 Simulator} - The J1939 simulator is a valuable tool for the development and testing of diagnostic programs and hardware. It simulates a Truck ECU .This simulator has 5 user-adjustable PIDs using 5 potentiometer , 5 live data can be changed and 6 fixed PGN values are provided. Pressing DTC button the trouble codes are generated and the MIL LED is ON. DM11 commands clear the DTCs and the MIL LED. Connection to the tester is provided via a J1962 female OBD port .ECU source address is 0x00.The Simulator supports DM1,DM5 \& DM11 Diagnostic Trouble Code messages.}
